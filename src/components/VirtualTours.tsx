...
import { Play, Eye, X, Volume2, VolumeX } from 'lucide-react';
...
const VirtualTours: React.FC = () => {
  ...
  const virtualTours = [
    {
      ...
      videoUrl: 'https://player.vimeo.com/video/example1' // Placeholder
    },
    {
      id: 2,
      ...
      videoUrl: 'https://player.vimeo.com/video/example2' // Placeholder
    },
    {
      id: 3,
      ...
      videoUrl: 'https://player.vimeo.com/video/example3' // Placeholder
    },
    {
      id: 4,
      ...
      videoUrl: 'https://player.vimeo.com/video/example4' // Placeholder
    },
    {
      id: 5,
      ...
      videoUrl: 'https://player.vimeo.com/video/example5' // Placeholder
    },
    {
      id: 6,
      ...
      videoUrl: 'https://player.vimeo.com/video/example6' // Placeholder
    }
  ];
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-sm">
        <div className="relative w-full h-full max-w-6xl max-h-[90vh] flex items-center justify-center">
          ...
          <div className="absolute bottom-4 right-4">
            <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-6 py-3 rounded-lg font-bold hover:from-yellow-300 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105">
              Book This Car
            </button>
          </div>
        </div>
  ...
  return (
    <section id="virtual-tours" className="py-20 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mt-16">
          <p className="text-gray-400 mb-6">
            Can't decide? Schedule a physical viewing at our showroom
          </p>
